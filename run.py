...
import torch
from exp.exp_AdaTCN import Exp_Main
import random
import numpy as np
from utils.str2bool import str2bool

parser = argparse.ArgumentParser(description='AdaTCN')
...
parser.add_argument('--model', type=str, required=True, default='AdaTCN',
                    help='model name, options: [AdaTCN]')
